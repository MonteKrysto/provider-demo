      ...
      invoke: {
        ...
        onDone: {
          ...
          actions: [
            ...
            ({ context, event }) => {
              ({ context, event }: { context: PracticeContext; event: DoneInvokeEvent<{ patients: any; notes: any; invoices: any; appointments: any }> }) => {
          ...
          guard: ({ event }) => {
            ...
            return true; // Simplified to always proceed for debugging
          },
        },
        onError: {
          target: 'running',
